...
{
	MTUA.TSTR.BIT.CST1 = 0;    			//MTU20カウント停止
	MTUA.TSTR.BIT.CST2 = 0;    			//MTU20カウント停止
	MTUB.TSTR.BIT.CST1 = 0;    			//MTU20カウント停止
	MTUB.TSTR.BIT.CST2 = 0;    			//MTU20カウント停止

	PORTC.ICR.BYTE=0xFF;
	IOPORT.PFCMTU.BIT.TCLKS = 1; 		// 0：選択
										// 1：PORTC選択
	IOPORT.PFDMTU.BIT.TCLKS = 0; 		// 0：PORTC選択
	...
	*/
	MTU1.TMDR.BIT.MD = 0x0004;			//ch1を位相計数モード1に設定
	MTU2.TMDR.BIT.MD = 0x0004;			//ch2を位相計数モード1に設定
	MTU1.TCNT = 0x0000;				//チャンネル1, カウンタクリアしとく
	MTU2.TCNT = 0x0000;				//チャンネル2, カウンタクリアしとく
	MTUA.TSTR.BIT.CST1 = 1;				//カウント開始	
	MTUA.TSTR.BIT.CST2 = 1;				//カウント開始
	
	
	
	MTU7.TMDR.BIT.MD = 0x0004;			//ch1を位相計数モード1に設定
	MTU8.TMDR.BIT.MD = 0x0004;			//ch2を位相計数モード1に設定
	MTU7.TCNT = 0x0000;				//チャンネル1, カウンタクリアしとく
	MTU8.TCNT = 0x0000;				//チャンネル2, カウンタクリアしとく
	MTUB.TSTR.BIT.CST1 = 1;				//カウント開始	
	MTUB.TSTR.BIT.CST2 = 1;				//カウント開始
